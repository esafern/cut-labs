...
KEY_SCHEMA=$(python3 -c "import json,sys; print(json.dumps(json.dumps(json.load(open('$DIR/schemas/packet-telemetry-key-v1.json')))))")
...
VALUE_SCHEMA=$(python3 -c "import json,sys; print(json.dumps(json.dumps(json.load(open('$DIR/schemas/packet-telemetry-value-v1.json')))))")
